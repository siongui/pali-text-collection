...
AUTHOR = u''
SITENAME = u'Pāli Texts Collection'
...
META_KEYWORDS = 'Pāli Texts Collection'
META_DESCRIPTION = 'Pāli Texts Collection'
...
CONTENT_DIR_URL = u'https://github.com/siongui/pali-text-collection/tree/main/content'
